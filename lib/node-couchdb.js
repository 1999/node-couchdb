    ...
    createDatabase(dbName) {
        return this._requestWrapped({
            ...
            if (res.statusCode === 400) {
                const rules = 'Name must begin with a lowercase letter (a-z), Lowercase characters (a-z), Digits (0-9) and any of the characters _, $, (, ), +, -, and /'
                throw new RequestError('EBADREQUEST', `Invalid database name: ${dbName}. Rules are ${rules}`, body);
            }
